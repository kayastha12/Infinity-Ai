...
import { Lock, RefreshCw, Mail, Calendar, User, MessageSquare, Trash2, Reply } from "lucide-react";
                ...
                <div className="md:w-64 flex flex-col gap-3 md:border-l border-white/10 md:pl-6">
                  ...
                  <div className="flex gap-2 mt-4 pt-4 border-t border-white/10">
                    ...
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-red-500/10 text-red-500 hover:bg-red-500/20 transition-colors text-sm"
                    >
